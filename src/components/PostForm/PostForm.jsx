...
import { addPost as addPostState, updatePost as updatePostState } from "../../features/posts/postsSlice"
      ...
      if (post) {
        ...
        try {
          ...
          if (dbPost) {
            ...
            dispatch(updatePostState({post: dbPost}))
        ...
        if (dbPost) {
          ...
          dispatch(addPostState({post: dbPost}));
          navigate(`/post/${dbPost.slug}`);
        }
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      <form
        ...
        className="flex flex-wrap gap-10 lg:gap-0"
      >
